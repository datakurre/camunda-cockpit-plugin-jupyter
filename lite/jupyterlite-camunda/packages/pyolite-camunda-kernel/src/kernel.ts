 ...
 */
export class PyoliteCamundaKernel extends BaseKernel implements IKernel {
  /**
   * Instantiate a new PyodideKernel
   *
   * @param options The instantiation options for a new PyodideKernel
   */
  constructor(options: PyoliteCamundaKernel.IOptions) {
    super(options);
   ...
   * @param options The instantiation options for a new PyodideKernel
   */
  protected buildWorkerScript(options: PyoliteCamundaKernel.IOptions): string[] {
...
/**
 * A namespace for PyoliteCamundaKernel statics.
 */
export namespace PyoliteCamundaKernel {
  /**
